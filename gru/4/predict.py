...
from keras.layers import Input, Masking, Bidirectional, GRU, Embedding, Dense, TimeDistributed, concatenate, Conv1D, \
    Reshape, Conv2D, MaxPool2D, GlobalMaxPool2D, ZeroPadding1D, Dropout
...
def predict(path):
    ...
    label_dic = {0: '未知', 1: '封面题目', 2: '题目', 3: '日期内容', 4: '机构', 5: '目录标题', 6: '目录内容', 7: '引言标题', 8: '引言内容', 9: '副题目',
                 10: '一级标题', 11: '文本段', 12: '二级标题', 13: '三级标题', 14: '表题编号', 15: '表题内容', 16: '表格', 17: '图片', 18: '图题编号', 19: '图题内容', 20: '公式', 21: '公式编号', 22: '四级编号', 23: '五级标题', 24: '六级标题',25:'说明'}
    ...
    dataFrame.to_csv("output/compareResult_BZ_predict.csv",index = False,encoding ='utf-8')


if __name__ == '__main__':
    predict('./input/BZprediction.csv')
